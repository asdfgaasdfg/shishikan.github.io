...
goldIm.src = "images/gold5.png";
goldIm.onload = function() {
    console.log('Gold image loaded');
};

var rockIm = new Image();
rockIm.src = "images/rock5.png";
rockIm.onload = function() {
    console.log('Rock image loaded');
};

var diamondIM = new Image();
diamondIM.src = "images/diamond2.jpg";
diamondIM.onload = function() {
